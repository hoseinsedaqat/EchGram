...
<template>
  <div v-if="returnDirectOne">
              <div class="w-100 h-100 d_bp">
                ...
                <span>
                  <img class="mr-3" :src="returnEachDirect.directImg" :alt="returnEachDirect.directImg"  width="30px" style="border-radius:50%;">
                  <small class="font-weight-bold">{{ returnEachDirect.userName }}</small>
                </span>
                <span class="h_lcp">
